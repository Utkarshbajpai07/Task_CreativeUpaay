      ...
      >
          ...
          {subtasks.map((subtask, index) => (
            <div key={index} className=" flex items-center w-full ">
              <input
                ...
                type="text"
                value={subtask.title}
                className="bg-transparent outline-none focus:border-0 grow px-4 py-2 rounded-md text-sm border-[0.5px] border-gray-600 focus:outline-[#635fc7] outline-[1px]"
                placeholder=" e.g Take coffee break"
              />
              <img
                src={crossIcon}
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <select
            ...
            className="select-status grow px-4 py-2 text-sm rounded-md bg-transparent border border-gray-300 outline-none focus:outline-[#635fc7]"
          >
